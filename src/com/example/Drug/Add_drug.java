...
public class Add_drug {
  ...
  public void placeComponents(JPanel p_container) {
    ...
    drug_code.setBounds(600, 35 + m, 200, 27);
    ...
    batch_n.setBounds(10, 90 + m, 200, 27);
    ...
    manu.setBounds(300, 65 + m, 200, 25);
    p_form.add(manu);

    JTextField manifacturer = new JTextField(20);
    manifacturer.setBounds(300, 90 + m, 200, 27);
